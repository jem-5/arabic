  ...
  return (
    <main className="flex-grow flex flex-col items-left p-3 text-neutral w-1/2 bg-[white] rounded-md mt-2 drop-shadow-xl border gap-3  max-[999px]:w-4/5">
      ...
      <p>
        ...
        Learning Arabic has been a lifelong dream of mine and I`&lsquo;`m
        finally diving into it. I developed ArabicRoad as an educational
        language learning platform designed to facilitate my own learning
        journey and to assist others who aspire to learn Arabic.
      </p>
      <p>
      ...
      <p>
        Let`&lsquo;`s explore the depth and beauty of the Arabic language
        together!
      </p>
    </main>
  );
